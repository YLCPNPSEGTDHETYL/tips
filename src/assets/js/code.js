...
Prism.languages.igor = {
    ...
    operation: {
        pattern: /\b(?:Abort|AbortOnRTE|Append|AppendImage|AppendToGraph|AppendToLayout|AppendToTable|Button|Change|Chart|CheckBox|Close|ColorTab2Wave|ControlBar|ControlInfo|ControlUpdate|Cursor|CurveFit|DefaultFont|DefaultGUIControls|DefaultGUIFont|DelayUpdate|DeleteFolder|DeletePoints|DimSize|Display|DoAlert|DoUpdate|DoWindow|DrawArc|DrawBezier|DrawLine|DrawOval|DrawPICT|DrawPoly|DrawRect|DrawRRect|DrawText|DrawUserShape|Duplicate|DuplicateDataFolder|Edit|Exists|ExperimentInfo|ExperimentModified|Execute|FuncFit|FunctionInfo|GetAxis|GetDataFolder|GetUserDataFolder|GetWaves|GetWavesData|Graph|GroupBox|HideInfo|HideProcedures|HideTools|InsertPoints|Integrate|Integrate2D|Interpolate2|Interpolate3D|KillControl|KillDataFolder|KillPath|KillStrings|KillVariables|KillWaves|KillWindow|Label|Layout|Legend|ListBox|Load|LoadData|LoadPICT|LoadWave|Make|MakeIndex|MatrixDeterminant|MatrixEigensystem|MatrixMultiply|MatrixRank|MatrixTranspose|Modify|ModifyControl|ModifyControlList|ModifyGraph|ModifyLayout|ModifyPanel|ModifyProcedure|ModifyTable|MoveDataFolder|MoveFile|MoveFolder|MoveString|MoveVariable|MoveWave|MoveWindow|NewImage|NewLayout|NewNotebook|NewPanel|NewPath|Note|Notebook|Open|PathInfo|PopupMenu|Preferences|Print|Printf|Redimension|Remove|RemoveFromGraph|RemoveFromLayout|RemoveFromTable|RemoveImage|Rename|RenameDataFolder|RenamePath|RenameWindow|Return|Rotate|Save|SaveData|SaveExperiment|SaveGraphCopy|SetAxis|SetDashPattern|SetDataFolder|SetDrawEnv|SetDrawLayer|SetScale|SetVariable|ShowIgorMenus|ShowInfo|ShowTools|Silent|Smooth|Sort|SortColumns|SplitString|SplitWave|Static|String|StringList|StrPrintf|StrSearch|StrSub|Switch|TabControl|Tag|Table|TextBox|TitleBox|Try|Variable|WindowInfo)\b/i,
        alias: 'keyword'
    },
    Programming: {
        pattern: /\b(?:break|ButtonControl|CheckboxControl|complex|Constant|continue|default|DefaultTab|DoPrompt|double|Do|While|End|EndMacro|EndStructure|FitFunc|For|EndFor|Function|Graph|GraphStyle|GridStyle|HDF5DataInfo|HDF5DatatypeInfo|HDF5LinkInfoStruct|HDF5SaveDataHook|HDF5SaveDataHookStruct|If|Else|EndIf|ElseIf|IgorVersion|int|int64|Layout|LayoutStyle|Macro|Menu|NVAR|Panel|Picture|Point|PointF|Popup|PopupMenuControl|Proc|ProcGrobal|Prompt|Rect|RectF|return|RGBAColor|RGBColor|root|SetVariableControl|Static|Strconstant|StrSwitch|Case|EndSwitch|STRUCT|Structure|Submenu|SVAR|Swich|Table|TableStyle|TextEncoding|Try|Catch|EndTry|version|WAVE|WaveClear|Window)\b/i,
        alias: 'programming'
    },
    
    function: {
        pattern: /\b(?:Inf|NaN|Pi|acos|acosh|alog|asin|asinh|atan|atan2|atanh|cos|cosIntegral|cosh|cot|coth|csc|csch|DataFolderDir|DataFolderExists|DataFolderList|Gauss|Gauss1D|Gauss2D|GetDataFolder|GetWavesDataFolder|date|date2secs|datetime|defined|e|ei|exp|expInt|expIntegralE1|interp|Interp2D|Interp3D|ln|log|max|min|mod|norm|note|num2char|num2istr|num2str|numpnts|numtype|sign|sin|sinIntegral|sinc|sinh|sqrt|stringmatch|strlen|strsearch|sum|tan|tanh|wavename)\b/,
        alias: 'function'
    },    
    operator: {
        pattern: /[-+*/^=<>!&|]/,
